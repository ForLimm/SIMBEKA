    ...
    <div class="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden">
        ...
        <form action="{{ route('gurubk.letters.sp2.store') }}" method="POST" class="p-8 space-y-6">
            ...
            <div>
                ...
                <div class="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-lg px-5 py-4 focus-within:ring-4 focus-within:ring-orange-500/10 focus-within:border-orange-500 transition max-w-sm">

...
<head>
    <meta charset="utf-8">
    <title>Surat Pemberitahuan Skorsing</title>
    <style>
        @page {
            margin: 0;
        }
...
<body>
            ...
            <td class="meta-left">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td>Hal</td>
                        <td>:</td>
                        <td><strong>Pemberitahuan Skorsing</strong></td>
                    </tr>
                </table>
            </td>
            <td class="meta-right">
    ...
    <div class="content">
        ...
        <p class="no-indent">Sehubungan dengan adanya pelanggaran tata tertib SMP Negeri 6 Palu yang dilakukan oleh siswa di bawah ini:</p>

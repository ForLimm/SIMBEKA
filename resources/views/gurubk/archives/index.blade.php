            ...
            <div @click.away="showExport = false" class="bg-white rounded-lg shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-300">
                <div class="bg-primary p-8 text-white flex items-center justify-between relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        <h3 class="font-semibold italic font-medium text-sm">Konfigurasi Laporan</h3>
                        <p class="text-blue-100 text-xs text-slate-500 font-medium mt-1 opacity-80">Pilih Data Terpadu</p>
                    </div>
                ...
                <form action="{{ route('gurubk.archives.export') }}" method="GET" class="p-8 space-y-6">
                    <div>
                        <label class="text-[10px] font-semibold text-slate-400 font-medium block mb-4 ml-1">Gabungkan Jenis Data</label>
                        <div class="space-y-3">
                            <label class="flex items-center gap-4 p-5 bg-slate-50 rounded-[1.5rem] border border-slate-100 cursor-pointer hover:border-primary/30 transition-all group">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-[9px] font-bold text-slate-400 font-medium mt-1">Data Sesi BK Tatap Muka</span>
                                </div>
                            </label>
                            <label class="flex items-center gap-4 p-5 bg-slate-50 rounded-[1.5rem] border border-slate-100 cursor-pointer hover:border-primary/30 transition-all group">
                                <div class="w-6 h-6 rounded-lg border-2 border-slate-200 flex items-center justify-center group-hover:border-primary/50 transition-colors">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-[9px] font-bold text-slate-400 font-medium mt-1">Data Kasus & Insiden Siswa</span>
                                </div>
                            </label>
                            <label class="flex items-center gap-4 p-5 bg-slate-50 rounded-[1.5rem] border border-slate-100 cursor-pointer hover:border-primary/30 transition-all group">
                                <div class="w-6 h-6 rounded-lg border-2 border-slate-200 flex items-center justify-center group-hover:border-primary/50 transition-colors">
                                ...
                                <div class="flex flex-col">
                                    <span class="text-sm font-semibold text-slate-800 leading-none">Arsip Surat Terbit</span>
                                    <span class="text-[9px] font-bold text-slate-400 font-medium mt-1">Surat Panggilan & Referensi</span>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            <label class="text-[10px] font-semibold text-slate-400 font-medium block mb-4 ml-1">Format Dokumen</label>
                            <div class="grid grid-cols-3 gap-2">
                                <label class="relative">
                                    <input type="radio" name="format" value="pdf" checked class="peer sr-only">
                                    <div class="py-4 px-1 rounded-lg border-2 border-slate-100 bg-slate-50 text-center cursor-pointer peer-checked:border-primary peer-checked:bg-primary/5 transition-all">
                                        <span class="block text-xs font-semibold text-slate-800 peer-checked:text-primary font-medium">PDF</span>
                                    </div>
                                </label>
                                <label class="relative">
                                    <input type="radio" name="format" value="word" class="peer sr-only">
                                    <div class="py-4 px-1 rounded-lg border-2 border-slate-100 bg-slate-50 text-center cursor-pointer peer-checked:border-primary peer-checked:bg-primary/5 transition-all">
                                        <span class="block text-xs font-semibold text-slate-800 peer-checked:text-primary font-medium">Word</span>
                                    </div>
                                </label>
                                <label class="relative">
                                    <input type="radio" name="format" value="excel" class="peer sr-only">
                                    <div class="py-4 px-1 rounded-lg border-2 border-slate-100 bg-slate-50 text-center cursor-pointer peer-checked:border-primary peer-checked:bg-primary/5 transition-all">
                                        <span class="block text-xs font-semibold text-slate-800 peer-checked:text-primary font-medium">Excel</span>
                                    </div>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="pt-4">
                        <button type="submit" @click="setTimeout(() => showExport = false, 500)" class="w-full bg-primary hover:bg-secondary text-white font-semibold py-4 rounded-[1.5rem] shadow-xl shadow-primary/20 transition-all active:scale-[0.95] font-medium text-xs flex items-center justify-center gap-3">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        @forelse($archives as $archive)
                            <tr class="hover:bg-slate-50/50 transition-colors group">
                                ...
                                <td class="px-8 py-6 text-right">
                                    <a href="{{ route('gurubk.archives.show', $archive->id) }}" class="inline-flex items-center gap-2 bg-white hover:bg-primary text-slate-400 hover:text-white font-bold px-4 py-2 rounded-lg border border-slate-200 hover:border-primary transition-all shadow-sm text-xs group/btn">
                                        Detail Kasus
                                        <svg class="w-4 h-4 transition-transform group-hover/btn:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg>
                                    </a>
                                </td>

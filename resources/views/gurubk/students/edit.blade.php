...
<div class="w-full space-y-4">
    ...
    <div class="flex items-center justify-between bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
        <div class="flex items-center gap-6">
            ...
            <div>
                <h2 class="text-2xl font-black text-slate-800 tracking-tight leading-none">Edit Data Siswa</h2>
                <p class="text-slate-400 text-[10px] font-bold uppercase tracking-widest mt-2">Pembaruan Informasi: {{ $student->name }}</p>
            </div>
        </div>
    </div>
            ...
            <div class="card-premium overflow-hidden bg-white">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-6 gap-x-5 gap-y-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="date" name="birth_date" value="{{ old('birth_date', $student->birth_date) }}" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition font-medium">
                    </div>
                    ...
                    <div class="md:col-span-4">
                        ...
                        <input type="text" name="address" value="{{ old('address', $student->address) }}" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition font-medium" placeholder="Alamat lengkap siswa">
                    </div>
            ...
            <div class="card-premium overflow-hidden bg-white">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="parents_address" rows="2" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition resize-none font-medium" placeholder="Kosongkan jika sama dengan siswa">{{ old('parents_address', $student->parents_address) }}</textarea>
                    </div>
                </div>
            </div>

    ...
    <div class="flex items-center justify-between bg-white p-6 rounded-lg border border-slate-100 shadow-sm">
        <div class="flex items-center gap-6">
            ...
            <div>
                ...
                <p class="text-slate-400 text-xs text-slate-500 font-medium mt-2">Pembaruan Informasi: {{ $student->name }}</p>
            </div>
        </div>
    </div>
            ...
            <div class="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden bg-white">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-6 gap-x-5 gap-y-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="date" name="birth_date" value="{{ old('birth_date', $student->birth_date) }}" class="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2.5 text-sm focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition font-medium">
                    </div>

...
<div class="w-full space-y-6">
    ...
    <div class="flex items-center justify-between bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
        <div class="flex items-center gap-6">
            ...
            <div>
                <h2 class="text-2xl font-black text-slate-800 tracking-tight leading-none">Riwayat Pelaporan</h2>
                <p class="text-slate-400 text-[10px] font-bold uppercase tracking-widest mt-2">Daftar Laporan Kasus yang Pernah Anda Ajukan</p>
            </div>
        </div>
        <div class="px-6 py-2 bg-rose-50 border border-rose-100 text-rose-600 rounded-2xl flex items-center gap-2">
            <span class="text-xl font-black">{{ $pelaporan->count() }}</span>
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors group">
                            ...
                            <td class="px-6 py-6 text-xs font-black">
                                @if($report->status === 'pending')
                                    <span class="px-4 py-1.5 rounded-full bg-slate-100 text-slate-500 border border-slate-200 uppercase tracking-widest text-[9px]">Menunggu Antrean</span>
                                ...
                                @else
                                    <span class="px-4 py-1.5 rounded-full bg-emerald-50 text-emerald-600 border border-emerald-100 uppercase tracking-widest text-[9px]">Selesai Ditangani</span>
                                @endif
                            </td>
                        ...
                        <tr>
                            <td colspan="4" class="px-8 py-20 text-center">
                                <div class="flex flex-col items-center opacity-10">
                                    ...
                                    <p class="text-xl font-black uppercase tracking-widest">Belum Ada Riwayat Pelaporan</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse

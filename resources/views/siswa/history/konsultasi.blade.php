                            ...
                            <td class="px-8 py-6">
                                <div class="flex items-center justify-center gap-3">
                                    @if($report->status === 'in-progress' && $report->handled_by)
                                        <a href="{{ route('chat.show', $report->id) }}" class="bg-primary hover:bg-secondary text-white text-[10px] font-semibold px-6 py-2.5 rounded-lg transition shadow-sm font-medium">
                                            Lanjut Percakapan
                                        </a>
                                    @endif

    ...
    <div class="w-full md:w-[45%] flex items-center justify-center p-6 md:p-10 overflow-y-auto custom-scrollbar bg-white">
        <div class="w-full max-w-sm">
            ...
            <div class="mb-6 p-4 bg-slate-50 rounded-lg border border-slate-100/80">
                <h4 class="text-[9px] font-semibold text-slate-400 font-medium mb-3 text-center">Akses Cepat (Akun Guest)</h4>
                <div class="grid grid-cols-2 gap-3">
                    <form action="{{ route('guest.login') }}" method="POST">
                        @csrf
                        <button type="submit" class="w-full flex items-center gap-3 p-3 bg-white border border-slate-200 rounded-lg hover:border-primary hover:shadow-md hover:shadow-primary/5 transition-all group">
                            ...
                            <span class="text-[9px] font-semibold uppercase tracking-wider text-slate-600 text-left leading-none">Lapor Anonim</span>
                        </button>
                    </form>
                    <form action="{{ route('guest.login') }}" method="POST">
                        @csrf
                        <button type="submit" class="w-full flex items-center gap-3 p-3 bg-white border border-slate-200 rounded-lg hover:border-primary hover:shadow-md hover:shadow-primary/5 transition-all group">
                            ...
                            <span class="text-[9px] font-semibold uppercase tracking-wider text-slate-600 text-left leading-none">Konsul Cepat</span>
                        </button>
                    </form>
                </div>
            </div>

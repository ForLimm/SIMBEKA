                        ...
                        <div>
                            ...
                            <div class="space-y-1">
                                ...
                                @if(auth()->user()->role === 'admin')
                                    ...
                                    {{-- Periode Akademik --}}
                                    <a href="{{ route('admin.academic_periods.index') }}" class="flex items-center gap-4 px-4 py-3.5 rounded-lg transition-all duration-200 group {{ request()->routeIs('admin.academic_periods.*') ? 'sidebar-item-active' : 'sidebar-item-inactive' }}">
                                        <svg class="w-5 h-5 {{ request()->routeIs('admin.academic_periods.*') ? 'text-white' : 'text-[#494b74] group-hover:text-white' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                        <span class="font-bold text-sm">Periode Akademik</span>
                                    </a>
                                @endif
                            </div>
                        </div>

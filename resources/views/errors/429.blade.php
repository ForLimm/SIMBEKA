...
<div class="flex items-center justify-center min-h-[60vh]">
    <div class="text-center max-w-md mx-auto">
        ...
        <h1 class="text-6xl font-black text-slate-900 mb-2">429</h1>
        ...
        <a href="{{ url()->previous() }}" class="inline-flex items-center gap-2 bg-primary hover:bg-secondary text-white font-bold py-3 px-6 rounded-xl transition shadow-lg shadow-primary/20">

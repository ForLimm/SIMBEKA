    ...
    <form action="{{ route('admin.teachers.update', $teacher->id) }}" method="POST" class="grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <div class="xl:col-span-4">
            <div class="bg-white border border-slate-200 rounded-lg shadow-sm bg-[#1e1e2d] border-none p-8 flex flex-col justify-center items-center text-center text-white relative overflow-hidden group">
                ...
                <h4 class="text-xl font-semibold mb-2 relative z-10">Perbarui Staf BK</h4>
                <p class="text-slate-500 text-xs text-slate-500 font-medium mb-8 relative z-10">Konfirmasi semua perubahan data akun Guru BK.</p>
                ...
                <div class="w-full space-y-3 relative z-10">
                    ...
                    <a href="{{ route('admin.teachers.index') }}" class="block w-full bg-white/5 hover:bg-white/10 text-slate-400 font-bold py-3 rounded-lg transition text-[9px] ">
                        Batal
                    </a>
                </div>
            </div>

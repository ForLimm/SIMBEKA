...
<div class="w-full space-y-4">
    ...
    <div class="flex items-center justify-between bg-white p-6 rounded-lg border border-slate-100 shadow-sm">
        <div class="flex items-center gap-6">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-slate-800 tracking-tight leading-none">Tambah Siswa Baru</h2>
                <p class="text-slate-500 text-xs font-medium mt-2">Daftarkan siswa secara manual ke dalam sistem.</p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('admin.students.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 xl:grid-cols-12 gap-6">
        @csrf
            ...
            <div class="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden bg-white">
                ...
                <div class="p-6 space-y-4">
                    <div>
                        ...
                        <p class="text-[9px] text-slate-400 mt-1 font-medium ml-1">Dapat dikosongkan agar nantinya diklaim oleh Guru BK masing-masing berdasarkan kelas.</p>
                    </div>
                </div>
            </div>
